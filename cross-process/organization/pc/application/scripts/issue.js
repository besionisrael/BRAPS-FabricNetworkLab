 ...
 * 4. Construct request to issue vdx paper
...
async function main() {
    ...
    try {
        ...
        const issueResponse = await contract.submitTransaction('issue', 'PC', '00001', '2022-11-21', 'PC', 'RQ');

        // process response
        console.log('Process issue transaction response.'+issueResponse);

        let paper = VdxPaper.fromBuffer(issueResponse);

        console.log(`${paper.issuer} vdx paper : ${paper.paperNumber} successfully issued for user ${paper.fullname}`);
