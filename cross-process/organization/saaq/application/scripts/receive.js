...
async function main() {
    ...
    try {
        ...
        const receivedResponse = await contract.submitTransaction('receive', 'PC', '00001', 'SAAQ', 'SAAQ', '2022-11-21', 'Document received');

        // process response
        console.log('Process receive transaction response.'+receivedResponse);
