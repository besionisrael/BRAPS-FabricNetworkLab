...
const ccpPath = '../gateway/connection-org2.yaml'
...
app.post('/api/receive', async function (req, res) {
    try {
        ...
        let data = req.body
        const result = await contract.submitTransaction('receive', 'PC', data.paperNumber, 'SAAQ',
...
app.post('/api/deliver', async function (req, res) {
    try {
        ...
        let data = req.body
        const result = await contract.submitTransaction('deliver', 'PC', data.paperNumber, 'SAAQ', 
